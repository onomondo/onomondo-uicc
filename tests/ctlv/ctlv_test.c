...
{
	uint8_t encoded[] = { 0x81, 0x03, 0x01, 0x21, 0x00, 0x82, 0x02, 0x81, 0x02, 0x8d, 0x0c, 0x04, 'H',  'E', 'L',
			      'L',  'O',  ',',	'W',  'O',  'R',  'L',	'D',  0xc8, 0x04, 0x01, 0x02, 0x03, 0x04 };
...
static void ss_ctlv_encode_test(void)
{
	...
	uint8_t encoded_expected[] = { 0x81, 0x03, 0x01, 0x21, 0x00, 0x82, 0x02, 0x81, 0x02, 0x8d,
				       0x0c, 0x04, 'H',	 'E',  'L',  'L',  'O',	 ',',  'W',  'O',
				       'R',  'L',  'D',	 0xc8, 0x04, 0x01, 0x02, 0x03, 0x04 };
	...
	ss_ctlv_new_ie(decoded, 0x0d, true, 12, (uint8_t *)"\x04\x48\x45\x4c\x4c\x4f\x2c\x57\x4f\x52\x4c\x44");
