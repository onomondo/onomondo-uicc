...
enum ss_access_intention {
	...
	SS_ACCESS_INTENTION_EF_UPDATE_ERASE =
		0x02, /*< EF: UPDATE BINARY, UPDATE RECORD, ERASE BINARY, ERASE RECORD(S) */
	...
	SS_ACCESS_INTENTION_EFDF_TERMINATE_CARD_OR_DF =
		0x20, /*< EF or DF: TERMINATE EF / TERMINATE CARD USAGE (MF), TERMINATE DF */
